...
public partial class themes_sulfer_premium_AdminBloodRequest : System.Web.UI.Page
{
        ...
        using (SqlConnection objConn = new SqlConnection(ConnectionString))
        {
            try
            {
                ...
                using (SqlCommand objCmd = objConn.CreateCommand())
                {
                    ...
                    objCmd.CommandText = "PR_Request_Blood_Delete";
    ...
    private void All_Donor()
    {
        ...
        using (SqlConnection objConn = new SqlConnection(connectionString))
        {
            try
            {
                ...
                {
                    objCmd.CommandType = CommandType.StoredProcedure;
                    objCmd.CommandText = "PR_RequestBlood_all";
    ...
    private void BloodType()
    {
        ...
        using (SqlConnection objConn = new SqlConnection(connectionString))
        {
            try
            {
                ...
                {
                    objCmd.CommandType = CommandType.StoredProcedure;
                    objCmd.CommandText = "PR_RequestBlood_SelectbyBloodRequest";
                    objCmd.Parameters.Add("@BloodType", SqlDbType.VarChar).Value = txtSearch.Text;
                    using (SqlDataReader objSDR = objCmd.ExecuteReader())
                    {
                        if (objSDR.HasRows)
                        {
