<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BloodRequest.aspx.cs" Inherits="themes_sulfer_premium_BloodRequest" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        Blood Group:  <asp:TextBox ID="txtBG" runat="server" Enabled="false" CssClass="form-control"></asp:TextBox>
        <br />
