<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminBloodDonationRequest.aspx.cs" Inherits="themes_sulfer_premium_AdminBloodDonationRequest" %>
...
<body>
    <form id="form1" runat="server">
        <header>
          ...
          <a href="Admin.aspx"><h3 class="text-center">Admin Home</h3></a>
        <br /><br />
    <h3 class="text-center">Request For Blood Donation :</h3><br /><br />
   ...
   <nav class="navbar navbar-inverse">
    ...
    <div class="col-md-12">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" BackColor="Yellow" CssClass="gv1 table table-responsive" 
